...
|	SetOprClauseList SetOpr '(' SetOprClauseList ')' OrderBy %prec lowerThanParenthese
	{
...
|	SetOprClauseList SetOpr '(' SetOprClauseList ')' SelectStmtLimit %prec lowerThanParenthese
	{
		setOprList1 := $1.([]ast.Node)
		setOprList2 := $4.([]ast.Node)
		nextSetOprList := &ast.SetOprSelectList{Selects: setOprList2}
...
|	SetOprClauseList SetOpr '(' SetOprClauseList ')' OrderBy SelectStmtLimit %prec lowerThanParenthese
	{
		setOprList1 := $1.([]ast.Node)
		setOprList2 := $4.([]ast.Node)
		nextSetOprList := &ast.SetOprSelectList{Selects: setOprList2}
